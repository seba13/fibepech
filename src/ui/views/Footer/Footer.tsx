    ...
    <div className="container">
      <div className="footer-top">
        <div>
          ...
          <p className="f-desc">
            Fundación Integral de Barberos, Estilistas y Peluqueros Educando por
            Chile
          </p>
          <div className="f-stripe" />
          <div className="social-row" style={{ marginTop: 14 }}>
            <a
              href="https://www.instagram.com/accounts/login/?next=https%3A%2F%2Fwww.instagram.com%2Fmvanesa.trivino.harros%2F&is_from_rle"
              target="_blank"
              rel="noreferrer"
        ...
        <div>
          ...
          <ul className="f-links">
            <li style={{ display: "flex", alignItems: "flex-start", gap: 6 }}>
              <MapPin
                size={11}
                style={{ color: "var(--terra-l)", flexShrink: 0, marginTop: 1 }}
              />{" "}
              Av. Gómez Carreño 666, Belloto norte, Quilpué
            </li>
            <li style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <Phone
                size={11}
                style={{ color: "var(--terra-l)", flexShrink: 0 }}
              />{" "}
              +56 9 8602 9932
            </li>
            <li style={{ display: "flex", alignItems: "center", gap: 6 }}>
      ...
      <div className="footer-bot">
        <span className="f-copy">
          FIBEPECH © 2026 · Todos los derechos reservados
        </span>
        <div className="f-pol">
          <span>Términos</span>
